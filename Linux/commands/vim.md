...
- Press `shift + v` to enter `line-wise-visual`, always select full lines.
...
- `ctrl + v`: Gets you into the visual mode, and you need to use the **arrow keys to select the multiple lines**, **don't use mouse cursor, it won't work**.
...
- Press `n` to move to the next occurrence of the searched pattern, Press `N` to move to the previous occurrence of the searched pattern.
